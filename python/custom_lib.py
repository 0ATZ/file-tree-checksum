...
class GeneratorBrake():
    def __init__(self, generator , enable : bool = True):
...
def sorted_walk(top, topdown=True, onerror=None, followlinks=False, reverse=False):
    """Note (JGH): This sorted walk is a modified version of the os.walk function.
            ...
            The sorted_walk function sorts the collected files/directories,
            ensuring that the 
    ...
    # sort the dirs and files in the current directory
    dirs.sort(reverse=reverse)
    nondirs.sort(reverse=reverse)
    walk_dirs.sort(reverse=reverse)
